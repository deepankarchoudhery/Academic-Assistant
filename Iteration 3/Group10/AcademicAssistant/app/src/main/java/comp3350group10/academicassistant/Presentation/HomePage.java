...
public class HomePage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button term = (Button)findViewById(R.id.termsBtn);
        Button transcript = (Button)findViewById(R.id.transcriptBtn);

        term.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(HomePage.this,ViewTerms.class);
        ...
        transcript.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(HomePage.this,Transcript.class);
                startActivityForResult(i,1);
            }
        });
    }
